...
public class Register implements Serializable {
    ...
    public UserProfile validateAndWriteToFile() throws IllegalArgumentException {
     ...
     if (!this.password.matches("^(?=.*[A-Z])(?=.*\\d)(?=\\S+$).{8,}$")) {
         throw new IllegalArgumentException("password must be at least 8 charecters long, contains atleast 1 digit, and have atleast 1 uppercase letter");
