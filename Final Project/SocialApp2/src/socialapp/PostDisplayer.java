...
public abstract class PostDisplayer extends BaseController{
    ...
    profilePic.setImage(new Image(getClass().getResourceAsStream("DefaultProfilePic.jpg")));
        ...
        //descriptionBox.setStyle("-fx-background-color:  #AA98A9;"); // Lilac color
        ...
        if(post.getPics() != null){
        	...
        	//image= new Image(getClass().getResourceAsStream("DefaultProfilePic.jpg"));
        	
        	System.out.println("777777777777666");
        	
            imageView.setImage(image);
            imageView.setFitWidth(300); // adjust width as needed
            imageView.setFitHeight(300); // adjust height as needed
        }
 ...
 //
    ...
    public abstract void openCommentWindow(Post post);
